...
uint16_t cpuAddrAbs     = 0x0000; // All used memory addresses end up in here
uint16_t cpuAddrRel     = 0x00;   // Represents absolute address following a branch
uint8_t  cpuOPCode      = 0x00;   // Is the instruction byte
